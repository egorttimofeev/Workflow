...
class AddEmployeeWindow(QtWidgets.QDialog):
    def __init__(self):
        ...
        self.label_id_user = QtWidgets.QLabel("ID пользователя:")
        self.input_id_user = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_id_user, 0, 0)
        self.layout.addWidget(self.input_id_user, 0, 1)
        ...
        self.layout.addWidget(self.label_surname, 3, 0)
        self.layout.addWidget(self.input_surname, 3, 1)

        self.label_phone_number = QtWidgets.QLabel("Телефон:")
        self.input_phone_number = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_phone_number, 4, 0)
        self.layout.addWidget(self.input_phone_number, 4, 1)

        self.label_birthday = QtWidgets.QLabel("День рождения:")
        self.input_birthday = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_birthday, 5, 0)
        self.layout.addWidget(self.input_birthday, 5, 1)

        self.label_passport = QtWidgets.QLabel("Паспорт:")
        self.input_passport = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_passport, 6, 0)
        self.layout.addWidget(self.input_passport, 6, 1)

        self.label_place_of_registration = QtWidgets.QLabel("Прописка:")
        self.input_place_of_registration = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_place_of_registration, 7, 0)
        self.layout.addWidget(self.input_place_of_registration, 7, 1)

        self.label_place_of_residence = QtWidgets.QLabel("Проживание:")
        self.input_place_of_residence = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_place_of_residence, 8, 0)
        self.layout.addWidget(self.input_place_of_residence, 8, 1)

        self.label_family = QtWidgets.QLabel("Семейное положение:")
        self.input_family = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_family, 0, 2)
        self.layout.addWidget(self.input_family, 0, 3)

        self.label_conscription = QtWidgets.QLabel("Воинская обязанность:")
        self.input_conscription = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_conscription, 1, 2)
        self.layout.addWidget(self.input_conscription, 1, 3)

        self.label_education = QtWidgets.QLabel("Образование:")
        self.input_education = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_education, 2, 2)
        self.layout.addWidget(self.input_education, 2, 3)

        self.label_login = QtWidgets.QLabel("Логин:")
        self.input_login = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_login, 3, 2)
        self.layout.addWidget(self.input_login, 3, 3)

        self.label_password = QtWidgets.QLabel("Пароль:")
        self.input_password = QtWidgets.QLineEdit()
        self.layout.addWidget(self.label_password, 4, 2)
        self.layout.addWidget(self.input_password, 4, 3)

        self.label_role = QtWidgets.QLabel("Роль:")
        self.combo_role = QtWidgets.QComboBox()
        self.combo_role.addItems(["Сотрудник", "Начальник"])
        self.layout.addWidget(self.label_role, 5, 2)
        self.layout.addWidget(self.combo_role, 5, 3)
        ...
        self.layout.addWidget(self.button_add, 6, 2, 1, 2)
